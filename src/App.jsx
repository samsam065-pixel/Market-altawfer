...
const LEVELS = [
  ...
  {level:8, targetScore:3300, moves:35, label:"خبير التسوق 👑"},
  {level:9, targetScore:3600, moves:35, label:"بطل التوفير 🏆"},
  {level:10, targetScore:4000, moves:35, label:"سيد السوق 🎖️"},
  {level:11, targetScore:4500, moves:30, label:"عاصفة العروض ⚡"},
  {level:12, targetScore:4800, moves:30, label:"تحدي الخصومات 🔥"},
  {level:13, targetScore:5200, moves:30, label:"صاروخ التسوق 🚀"},
  {level:14, targetScore:6100, moves:30, label:"ملك العروض 👑"},
  {level:15, targetScore:7200, moves:30, label:"أسطورة السوق 🌟"},
  {level:16, targetScore:7500, moves:30, label:"محترف الصفقات 💼"},
  {level:17, targetScore:8000, moves:30, label:"قناص العروض 🎯"},
  {level:18, targetScore:8700, moves:30, label:"ساحر الأسواق 🪄"},
  {level:19, targetScore:9600, moves:30, label:"مدير التسوق 📊"},
  {level:20, targetScore:10000, moves:30, label:"خبير التوفير 💎"},
  {level:21, targetScore:10500, moves:30, label:"بوابة المول 🏬"},
  {level:22, targetScore:10800, moves:30, label:"عروض المول 🎪"},
  {level:23, targetScore:11100, moves:30, label:"متاجر الأزياء 👗"},
  {level:24, targetScore:11800, moves:30, label:"مطاعم المول 🍽️"},
  {level:25, targetScore:12200, moves:30, label:"سينما المول 🎬"},
  {level:26, targetScore:13300, moves:30, label:"ألعاب المول 🎮"},
  {level:27, targetScore:13800, moves:30, label:"مجوهرات المول 💍"},
  {level:28, targetScore:14400, moves:30, label:"VIP المول 🌟"},
  {level:29, targetScore:14900, moves:30, label:"بطل المول 🏆"},
  {level:30, targetScore:15500, moves:30, label:"ملك المول 👑"},
  {level:31, targetScore:16000, moves:30, label:"مستودع صغير 📦"},
  {level:32, targetScore:16600, moves:30, label:"مستودع متوسط 🏭"},
  {level:33, targetScore:17700, moves:30, label:"مستودع كبير 🏗️"},
  {level:34, targetScore:18000, moves:30, label:"مدير المستودع 📋"},
  {level:35, targetScore:18800, moves:30, label:"خبير التخزين 🔧"},
  {level:36, targetScore:19500, moves:30, label:"أمين المخزن ⚙️"},
  {level:37, targetScore:20000, moves:30, label:"قائد الشحن 🚛"},
  {level:38, targetScore:20700, moves:30, label:"محترف اللوجستيك 🗺️"},
  {level:39, targetScore:21600, moves:30, label:"عملاق التوزيع 💪"},
  {level:40, targetScore:22700, moves:30, label:"سيد المستودع 🏅"},
  {level:41, targetScore:23000, moves:25, label:"سوق الذهب الصغير 💛"},
  {level:42, targetScore:24500, moves:25, label:"تاجر الذهب 🥇"},
  {level:43, targetScore:25200, moves:25, label:"صائد الكنوز 💎"},
  {level:44, targetScore:26100, moves:25, label:"ملك الذهب 👸"},
  {level:45, targetScore:27200, moves:25, label:"أمير الثروة 🤴"},
  {level:46, targetScore:28500, moves:25, label:"حارس الخزينة 🔐"},
  {level:47, targetScore:29000, moves:25, label:"سيد الثروة 💰"},
  {level:48, targetScore:30700, moves:25, label:"إمبراطور الذهب ⚜️"},
  {level:49, targetScore:31600, moves:25, label:"أسطورة الثروة 🌠"},
  {level:50, targetScore:32700, moves:25, label:"قمة الذهب 🏔️"},
  {level:51, targetScore:33300, moves:25, label:"بوابة الإمبراطورية 🏯"},
  {level:52, targetScore:34500, moves:25, label:"قاعة العرش 🎖️"},
  {level:53, targetScore:35200, moves:25, label:"حارس التاج 🛡️"},
  {level:54, targetScore:36100, moves:25, label:"وزير التوفير 📜"},
  {level:55, targetScore:37200, moves:25, label:"قائد الجيش 🎯"},
  {level:56, targetScore:38500, moves:25, label:"أمير الإمبراطورية 👑"},
  {level:57, targetScore:40000, moves:25, label:"حاكم المدينة 🌆"},
  {level:58, targetScore:44700, moves:25, label:"سلطان التوفير 🕌"},
  {level:59, targetScore:45600, moves:25, label:"الإمبراطور الأكبر 🌍"},
  {level:60, targetScore:49000, moves:25, label:"سيد Altawfer الأعظم 🏆"},
];
