...
const LEVELS = [
  ...
  {level:3, targetScore:1200, moves:35, label:"جمع النقاط 📈"},
  {level:4, targetScore:1700, moves:35, label:"متسوق ذكي 🧠"},
  {level:5, targetScore:2300, moves:35, label:"خصم كبير 🏷️"},
  {level:6, targetScore:3000, moves:35, label:"عرض الموسم 🎪"},
  {level:7, targetScore:3800, moves:35, label:"صيد الصفقات 🎣"},
  {level:8, targetScore:4700, moves:35, label:"خبير التسوق 👑"},
  {level:9, targetScore:5700, moves:35, label:"بطل التوفير 🏆"},
  {level:10, targetScore:6800, moves:35, label:"سيد السوق 🎖️"},
  {level:11, targetScore:8000, moves:30, label:"عاصفة العروض ⚡"},
  {level:12, targetScore:9500, moves:30, label:"تحدي الخصومات 🔥"},
  {level:13, targetScore:11200, moves:30, label:"صاروخ التسوق 🚀"},
  {level:14, targetScore:13100, moves:30, label:"ملك العروض 👑"},
  {level:15, targetScore:15200, moves:30, label:"أسطورة السوق 🌟"},
  {level:16, targetScore:17500, moves:30, label:"محترف الصفقات 💼"},
  {level:17, targetScore:20000, moves:30, label:"قناص العروض 🎯"},
  {level:18, targetScore:22700, moves:30, label:"ساحر الأسواق 🪄"},
  {level:19, targetScore:25600, moves:30, label:"مدير التسوق 📊"},
  {level:20, targetScore:28700, moves:30, label:"خبير التوفير 💎"},
  {level:21, targetScore:32000, moves:30, label:"بوابة المول 🏬"},
  {level:22, targetScore:35500, moves:30, label:"عروض المول 🎪"},
  {level:23, targetScore:39200, moves:30, label:"متاجر الأزياء 👗"},
  {level:24, targetScore:43100, moves:30, label:"مطاعم المول 🍽️"},
  {level:25, targetScore:47200, moves:30, label:"سينما المول 🎬"},
  {level:26, targetScore:51500, moves:30, label:"ألعاب المول 🎮"},
  {level:27, targetScore:56000, moves:30, label:"مجوهرات المول 💍"},
  {level:28, targetScore:60700, moves:30, label:"VIP المول 🌟"},
  {level:29, targetScore:65600, moves:30, label:"بطل المول 🏆"},
  {level:30, targetScore:70700, moves:30, label:"ملك المول 👑"},
  {level:31, targetScore:76000, moves:30, label:"مستودع صغير 📦"},
  {level:32, targetScore:81500, moves:30, label:"مستودع متوسط 🏭"},
  {level:33, targetScore:87200, moves:30, label:"مستودع كبير 🏗️"},
  {level:34, targetScore:93100, moves:30, label:"مدير المستودع 📋"},
  {level:35, targetScore:99200, moves:30, label:"خبير التخزين 🔧"},
  {level:36, targetScore:105500, moves:30, label:"أمين المخزن ⚙️"},
  {level:37, targetScore:112000, moves:30, label:"قائد الشحن 🚛"},
  {level:38, targetScore:118700, moves:30, label:"محترف اللوجستيك 🗺️"},
  {level:39, targetScore:125600, moves:30, label:"عملاق التوزيع 💪"},
  {level:40, targetScore:132700, moves:30, label:"سيد المستودع 🏅"},
  {level:41, targetScore:140000, moves:25, label:"سوق الذهب الصغير 💛"},
  {level:42, targetScore:147500, moves:25, label:"تاجر الذهب 🥇"},
  {level:43, targetScore:155200, moves:25, label:"صائد الكنوز 💎"},
  {level:44, targetScore:163100, moves:25, label:"ملك الذهب 👸"},
  {level:45, targetScore:171200, moves:25, label:"أمير الثروة 🤴"},
  {level:46, targetScore:179500, moves:25, label:"حارس الخزينة 🔐"},
  {level:47, targetScore:188000, moves:25, label:"سيد الثروة 💰"},
  {level:48, targetScore:196700, moves:25, label:"إمبراطور الذهب ⚜️"},
  {level:49, targetScore:205600, moves:25, label:"أسطورة الثروة 🌠"},
  {level:50, targetScore:214700, moves:25, label:"قمة الذهب 🏔️"},
  {level:51, targetScore:224000, moves:25, label:"بوابة الإمبراطورية 🏯"},
  {level:52, targetScore:233500, moves:25, label:"قاعة العرش 🎖️"},
  {level:53, targetScore:243200, moves:25, label:"حارس التاج 🛡️"},
  {level:54, targetScore:253100, moves:25, label:"وزير التوفير 📜"},
  {level:55, targetScore:263200, moves:25, label:"قائد الجيش 🎯"},
  {level:56, targetScore:273500, moves:25, label:"أمير الإمبراطورية 👑"},
  {level:57, targetScore:284000, moves:25, label:"حاكم المدينة 🌆"},
  {level:58, targetScore:294700, moves:25, label:"سلطان التوفير 🕌"},
  {level:59, targetScore:305600, moves:25, label:"الإمبراطور الأكبر 🌍"},
  {level:60, targetScore:316700, moves:25, label:"سيد Altawfer الأعظم 🏆"},
];
